...
def run(rank, n_gpus, hps):
  ...
  print("===============================================================")
  print("-Epochs:", hps.train.epochs)
  print("-Batch sizes:", hps.train.batch_size)
  print("-Max train steps:", (hps.train.epochs) * len(train_loader))
  # accelerator.print("-Optimizer:", optim_class.__name__)
  print("-Learning rate:", hps.train.learning_rate)
  print("-Text cleaners:", hps.data.text_cleaners)
  print("-Sampling rate:", hps.data.sampling_rate)
  print("==================All looks good, ready to train===============")

  scaler = GradScaler(enabled=hps.train.fp16_run)
  global process_bar
  process_bar = tqdm.tqdm(range(0, (hps.train.epochs) * len(train_loader)), desc='Steps')
